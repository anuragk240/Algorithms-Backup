...
public class MergingTables {
    ...
    void merge(Table destination, Table source) {
		...
		int max = realSource.numberOfRows + realDestination.numberOfRows;
		if(realDestination.rank == realSource.rank){
			realDestination.parent = realSource;
			realSource.rank++;
			realSource.numberOfRows = max;
		} else if(realDestination.rank < realSource.rank){
			realDestination.parent = realSource;
			realSource.numberOfRows = max;
		} else {
			realSource.parent = realDestination;
			realDestination.numberOfRows = max;
		}
		
		maximumNumberOfRows = Math.max(maximumNumberOfRows, max);
    }
